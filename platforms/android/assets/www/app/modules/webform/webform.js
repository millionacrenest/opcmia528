...
function webform_form_pageshow(options) {
    try {
        ...
        webform_submissions_index(options.uuid, query, {
                            success: function(submissions) {
                            //dpm('webform_submissions_index');
...
function webform_results_pageshow(nid) {
    try {
        ...
        webform_submissions_index(query, {
 ...
 *
 */
function webform_submissions_index(uuid, query, options) {
    try {
        options.method = 'GET';
    ...
    catch (error) { console.log('webform_submissions_index - ' + error); }
}
 ...
 * @param {Object} options
 */
function webform_submissions_index(query, options) {
    try {
        alert('webform_submissions_index is deprecated! Use webform_submissions_index() instead.');
        return;
